...
- (void)layoutSubviews {
    ...
    //计算文本的大小
    CGSize labelSize = [label.text boundingRectWithSize:CGSizeMake(self.frame.size.width, CGFLOAT_MAX) options:NSStringDrawingUsesLineFragmentOrigin attributes:attributes context:nil].size;
    ...
    //获得文本属性
    NSMutableParagraphStyle * detailsLabelparagraphStyle = [[NSMutableParagraphStyle alloc]init];
    detailsLabelparagraphStyle.lineBreakMode = NSLineBreakByWordWrapping;
    NSDictionary * detailsLabelattributes = @{NSFontAttributeName:detailsLabel.font, NSParagraphStyleAttributeName:detailsLabelparagraphStyle.copy};
    
    //计算文本的大小
    CGSize detailsLabelSize = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:detailsLabelattributes context:nil].size;
